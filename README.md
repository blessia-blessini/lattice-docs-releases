...
> [!NOTE]
> **This repository is a publishing channel, not a development repository.**
> It exists solely to distribute Lattice releases and documentation to end users.
> Pull requests and external contributions are not accepted here.
> If you'd like to contribute to Lattice, please visit the main development repository.
> 
> Lattice development repo link: [blessia-blessini/lattice](https://github.com/blessia-blessini/lattice)

## Repository Purpose

This repository is with the sole purpose of maintaining the releases and public communication of Lattice.

## Licensing

This software "Lattice" is dual-licensed:
